...
Costuma ter três blocos, mesmo que a conversa não os nomeie:

1. **Motivo da procura.** O que te trouxe agora — não a biografia completa. «Estou ansioso no trabalho e já não durmo» chega.
2. **Contexto.** Sono, trabalho, relações, saúde, tentativas anteriores de ajuda. O psicólogo faz perguntas; não é um interrogatório.
3. **Enquadramento.** Como trabalha, frequência, confidencialidade, e o que podes esperar das próximas sessões.

Não há «resposta certa». Se te calares, isso também é informação. Se chorares, também.

{{cta}}

## O que dizer na primeira consulta de psicologia?

Diz o que conseguires, mesmo que saia desordenado. Três âncoras úteis:

- **O que está a doer agora** (sintoma, conflito, esgotamento)
- **Há quanto tempo** e o que já tentaste
- **O que gostarias que mudasse** — mesmo que seja só «conseguir funcionar»

Podes levar notas. Podes dizer «não sei por onde começar». Podes perguntar a abordagem do psicólogo, a regularidade e o que acontece se quiseres mudar.
...
Está tudo bem. Duas ou três sessões chegam, na maior parte dos casos, para perceber se te sentes ouvida. Se não for o encaixe, **podes mudar de psicólogo sempre que quiseres, sem precisares de dar qualquer justificação — e recomeçar do zero.** Ninguém te pede contas.

A videochamada é no **browser** (Doxy.me), sem instalar aplicações. Escolhe pelo [perfil](/saudemental) ou pela [triagem](/triagem).
...
O psicólogo procura conhecer-te e perceber o motivo da procura: história recente, contexto e expectativas. Não é preciso um discurso preparado.

### O que dizer na primeira consulta de psicologia?

O que está a doer agora, há quanto tempo, e o que gostarias que mudasse. Notas ou um «não sei por onde começar» são válidos.
