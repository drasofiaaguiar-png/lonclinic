...
Na Lon Clinic essa avaliação é **online**, com médica inscrita na [Ordem dos Médicos](https://www.ordemdosmedicos.pt/). A clínica está registada na [ERS](https://www.ers.pt/) (n.º 45475). A administração das vacinas do circuito internacional **não** acontece na videochamada.

{{cta}}

## Quando marcar a consulta de viajante?

O intervalo de **4 a 6 semanas** é a orientação frequente das clínicas de viagem, não um protocolo Lon que «garante» imunidade. Serve porque:

- algumas vacinas precisam de tempo para gerar protecção
- certas vacinas pedem mais do que uma dose
- o certificado de febre amarela, quando emitido no CVI, **só é válido 10 dias após a vacinação** — facto de certificado, não de «o país exige» este artigo

Com menos antecedência, [ainda vale marcar](/blog/consulta-do-viajante-urgente): o aconselhamento e, quando indicado, a prescrição no próprio dia continuam úteis. O gargalo passa a ser a vaga no CVI, não a consulta.

## Que vacinas se avaliam numa consulta de viajante?
...
- **Reforços de rotina** (por exemplo tétano ou sarampo) se estiverem desactualizados

A decisão é clínica e depende da zona (urbana ou rural), da estação e do que já tomou. Guia mais longo: [vacinas do viajante](/blog/vacinas-viajante-guia-completo).
...
## A consulta de viajante pode ser online?

**Sim**, a avaliação — histórico, destino, vacinas já tomadas — faz-se por videochamada. Na Lon Clinic o slot de **1 pessoa dura 20 minutos** (não 30 de clínica geral). O médico determina o que está indicado. A vacina em si exige presença física num CVI. Em regra os CVI públicos pedem **prescrição médica**; sem receita, muitos centros nem marcam a toma.
...
Não inventamos tempos de espera nem um «centro Lon». A toma do circuito internacional (incluindo febre amarela e o certificado CIVP) faz-se nos **Centros de Vacinação Internacional**. Lista com contactos que o site já publica: [CVI em Portugal](/blog/centros-de-vacinacao-internacional-portugal). Confirme stock, marcação e o que levar **no próprio centro** e na [DGS](https://www.dgs.pt/). A [CUF não administra o circuito CVI](/blog/vacinas-viajante-cuf).

## Como funciona na Lon Clinic?

1. Marca a [consulta do viajante](/marcar/travel) — **39 €** visível antes de pagar.
2. Videoconsulta no browser (sem app), com o itinerário à mão.
3. Quando indicado, sai **prescrição** no próprio dia para o CVI e, se couber, receita de profilaxia para a farmácia.
4. Toma as vacinas no CVI que escolher. Vacinas e comprimidos **não** estão nos 39 €.

Critérios para não escolher uma plataforma só pelo preço: [como escolher telemedicina](/blog/melhores-plataformas-telemedicina). A Lon não substitui urgência: **112** ou **SNS 24 (808 24 24 24)**.
...
### Preciso mesmo de vacinas para todos os destinos fora da Europa?

Não necessariamente — depende do destino específico, da zona (urbana ou rural), da duração e do tipo de viagem. É por isso que a avaliação é individualizada, e não um pacote genérico de vacinas.

### O que acontece se marcar a consulta em cima da viagem?
...
Este artigo tem fins informativos e não substitui uma avaliação clínica individual. Em emergência, ligue **112**. Para orientação não urgente: **SNS 24 (808 24 24 24)**.

## Fontes

- Preçário e durações Lon Clinic, 2026 — `pricing.js` (39 / 69 / 107 / 136 €) e `booking.js` (20 / 30 / 40 min)
- [consulta/vacinas-viagem](/consulta/vacinas-viagem) — administração no CVI, não na videochamada
- [DGS](https://www.dgs.pt/)
- [OMS — febre amarela](https://www.who.int/news-room/fact-sheets/detail/yellow-fever)
- [Ordem dos Médicos](https://www.ordemdosmedicos.pt/) · [ERS](https://www.ers.pt/) n.º 45475
