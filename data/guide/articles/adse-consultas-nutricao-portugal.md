...
|---|---|---|
| Onde | Prestador da rede ADSE | Nutricionista que escolher, com cédula |
| Como paga | Copagamento no acto | Paga o preço e pede reembolso |
| Lon Clinic | Não | **Sim** — recibo com NIF |

Valores pagos ao prestador e copagamentos do convencionado **estão na tabela da rede** — não os copiamos para este artigo.
...
A ADSE passou a falar de teleconsultas e de nutrição nas tabelas de 2025. Se a *sua* videochamada entra no acto reembolsável, só a ADSE Direta / a tabela do dia o confirmam.

### Quanto recebo de volta se pagar uma consulta de nutrição em regime livre?

O teto do acto está na tabela ADSE em vigor. Não afirmamos um euro fixo neste artigo. Use o simulador da ADSE Direta com a data do recibo.

### Preciso de uma consulta médica prévia para a ADSE comparticipar a consulta de nutrição?

Confirme na ADSE Direta e na nomenclatura do acto. Não publicamos aqui uma exigência de receita que a tabela vigente não confirme — nem o contrário como garantia para 2026.

---

Este artigo tem fins informativos e não substitui aconselhamento da ADSE nem uma consulta nutricional individual. Em emergência, ligue **112**.
