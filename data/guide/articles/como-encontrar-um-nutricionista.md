...
Escolher nutricionista tem um problema parecido com [escolher psicólogo](/blog/como-encontrar-um-psicologo), mas com uma armadilha extra: é uma área onde é fácil confundir «vender-nos qualquer coisa» com «cuidar da nossa saúde». E, ao contrário de uma consulta médica em que os sinais de alarme costumam ser óbvios, com nutrição os sinais são mais subtis — e às vezes só percebemos que algo estava errado meses depois, quando o suplemento caro que nos venderam não fez diferença nenhuma.
...
- **Impinge suplementos** logo na primeira consulta, muitas vezes vendidos directamente por ele ou pela clínica, antes sequer de perceber bem o teu historial.
- Propõe **dietas de «3 passos»**, planos de batidos substitutivos, ou fórmulas milagrosas com nome apelativo — o tipo de abordagem que promete resultados rápidos, mas raramente é sustentável a longo prazo. A [perda de peso sustentável](/blog/perda-de-peso-sustentavel) pede o contrário: mudanças que aguentem meses, não duas semanas.
- Sugere lanches como **bolachas ou barras processadas** em vez de comida real, porque é mais fácil de «prescrever» do que ensinar a comer bem.
...
Isto não é incompetência — é, outra vez, uma questão de encaixe. E é exactamente por isso que escolher nutricionista merece o mesmo cuidado que escolher psicólogo: não basta ser bom, tem de ser bom *para ti*.
...
O acompanhamento é continuado, não pontual — o [programa de reeducação metabólica](/nutricao/programa) custa 115 € no primeiro mês e 75 €/mês a partir daí (duas consultas por mês, compromisso de três meses). Guia da consulta: [preço, como funciona e quando marcar](/blog/consulta-nutricao-preco-como-funciona). Custos e ADSE: [quanto custa uma consulta de nutrição](/blog/quanto-custa-consulta-nutricao-portugal) · [ADSE e nutrição](/blog/adse-consultas-nutricao-portugal). Cheque público (12–35): [Cheque-Nutricionista 2026](/blog/cheque-nutricionista-2026) — a Lon **não** se apresenta como aderente. Títulos: [nutricionista ou dietista](/blog/nutricionista-ou-dietista-portugal). Se a [fome emocional](/blog/fome-emocional-vs-fisica) mandar no processo, há um programa completo com psicologia. Podes começar pela [avaliação metabólica](/nutricao/avaliacao) (dois minutos) e deixar que a equipa te oriente, ou [marcar a consulta inicial](/marcar/nutricao-programa) directamente. Se o encaixe com o profissional não funcionar, podes pedir para mudar — sem precisares de justificar o desconforto.

{{cta}}

[lon-slots: serviço="nutricao-programa"]

Contudo, há também quem prefira o acompanhamento presencial. Para essas situações:
...
### Como sei se o nutricionista está a vender-me um produto em vez de me acompanhar?

Sinais úteis: suplementos ou batidos logo na primeira consulta, vendidos pela própria clínica; dietas com nome de marketing e prazo milagroso; lanches processados no lugar de comida real. Um plano que começa pela tua alimentação e só suplementa com indicação clínica vai no sentido contrário.

### Como confirmo se um nutricionista pode exercer em Portugal?

Pede o número de cédula profissional e confirma no [registo nacional da Ordem dos Nutricionistas](https://www.ordemdosnutricionistas.pt/registoNacional.php?cod=0C0A), pelo nome ou pelo número. Sem inscrição, o exercício da profissão não é legal.

### E se o plano estiver certo mas eu não me sentir motivada?

Também é motivo para mudar. Explicar o «o quê» sem um «porquê» que te faça sentido, ou um tom demasiado distante para os hábitos que precisas de alterar, é um mau encaixe — não um falhanço teu.

### A Lon Clinic vende suplementos ou receituário de Ozempic?

Não. A abordagem é alimentação e hábitos. A clínica não prescreve aGLP-1 para perda de peso; suplementação, quando entra, é excepção clínica, não venda.
...
- [CDC — Healthy Weight](https://www.cdc.gov/healthy-weight-growth/site.html) (perda de peso gradual e hábitos duradouros, não dietas de curto prazo)
- Estatuto da Ordem dos Nutricionistas — a inscrição e a cédula profissional são condição para o exercício da profissão em Portugal
