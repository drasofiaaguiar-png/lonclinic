  ...
  return (
    <section className="py-24 lg:py-32" style={{ backgroundColor: bgColor }}>
      <div className="max-w-[1400px] mx-auto px-6">
        {/* Header */}
        <div className="mb-12">
          <h2 className="text-[clamp(2rem,5vw,3.5rem)] font-bold mb-6 tracking-[-0.02em]" style={{ color: 'var(--gray-700)' }}>
            Transformações inspiradoras de <span style={{ color: 'var(--beige-muted)' }}>pessoas reais como você</span>
          </h2>
        </div>
        ...
        <div className="relative -mx-6 px-6">
          <div className="flex gap-6 overflow-x-auto pb-4 scrollbar-hide snap-x snap-mandatory">
            ...
            <div className="relative bg-[#C4A892] rounded-[32px] p-8 lg:p-12 overflow-hidden min-w-[500px] h-[500px] flex flex-col justify-between flex-shrink-0 snap-start">
            {/* Before/After Labels */}
            ...
            {/* Card 2 */}
            <div className="relative bg-[#B8A598] rounded-[32px] p-8 overflow-hidden min-w-[420px] h-[500px] flex flex-col justify-between flex-shrink-0 snap-start">
              <div className="flex justify-between items-start mb-8">
                <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                  <p className="text-white/90 text-sm font-medium">Antes</p>
                  <p className="text-white text-2xl font-bold">88 kg</p>
                </div>
                <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                  <p className="text-white/90 text-sm font-medium">Depois</p>
                  <p className="text-white text-2xl font-bold">72 kg</p>
                </div>
              </div>

              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 rounded-full overflow-hidden border-4 border-white/30">
                <Image
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                <p className="text-white text-sm leading-relaxed mb-2">
                  "Recuperei a minha energia e confiança."
                </p>
                <p className="text-white/80 text-xs">Ana, 28 anos · 5 meses</p>
              </div>
            </div>

            {/* Card 3 */}
            <div className="relative bg-[#D4C4B8] rounded-[32px] p-8 overflow-hidden min-w-[420px] h-[500px] flex flex-col justify-between flex-shrink-0 snap-start">
              <div className="flex justify-between items-start mb-8">
                <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                  <p className="text-white/90 text-sm font-medium">Antes</p>
                  <p className="text-white text-2xl font-bold">102 kg</p>
                </div>
                <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                  <p className="text-white/90 text-sm font-medium">Depois</p>
                  <p className="text-white text-2xl font-bold">85 kg</p>
                </div>
              </div>

              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 rounded-full overflow-hidden border-4 border-white/30">
                <Image
                  src="/image/consulta-clinica-geral.webp"
                  alt="Transformação"
                  fill
                  className="object-cover"
                  sizes="192px"
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                <p className="text-white text-sm leading-relaxed mb-2">
                  "Mudei completamente os meus hábitos alimentares."
                </p>
                <p className="text-white/80 text-xs">James, 41 anos · 4 meses</p>
              </div>
            </div>

            {/* Small Cards Grid - As separate items */}
            <div className="relative bg-white rounded-[24px] p-8 shadow-lg min-w-[380px] h-[500px] flex flex-col justify-center flex-shrink-0 snap-start">
            ...
            <div className="relative bg-[#B8A598] rounded-[24px] overflow-hidden h-[500px] min-w-[380px] flex-shrink-0 snap-start">
              <Image
                src="/image/hero-bay.webp"
                alt="Transformação"
                fill
