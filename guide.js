...
<head>
    ...
    <link rel="stylesheet" href="/guide.css?v=20260820b">
...
function renderBlogArticle(origin, slug) {
    ...
    const html = layoutMagazinePage({
        ...
        extraCssAfter: ['/guide.css?v=20260820b', '/author.css?v=20260818a', '/magazine.css?v=20260820b'],
...
<head>
    ...
    ${extraCssHtml}
    <link rel="stylesheet" href="/magazine.css?v=20260820b">
    ${extraCssAfterHtml}
    <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><text y='.9em' font-size='90'>🩺</text></svg>">
    <link rel="sitemap" type="application/xml" href="/sitemap.xml">
    ${jsonLdScript(graph)}
