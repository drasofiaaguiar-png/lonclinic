...
function buildLlmsTxt() {
    ...
    const lines = [
        ...
        mdLink('Índice da Magazine', '/magazine/indice'),
        '',
        '## Bem-estar',
        mdLink('LON Wellness Club', '/wellness/club'),
        mdLink('Benefícios do pilates', '/blog/beneficios-do-pilates'),
        mdLink('Pilates em Lisboa', '/blog/pilates-lisboa-como-escolher-estudio'),
        mdLink('Pilates clínico', '/blog/pilates-clinico'),
        mdLink('Benefícios do padel', '/blog/beneficios-do-padel'),
        mdLink('Onde jogar padel em Lisboa', '/blog/onde-jogar-padel-lisboa'),
        mdLink('Massagem em Lisboa', '/blog/massagem-lisboa'),
        mdLink('Yoga em Lisboa', '/blog/yoga-lisboa'),
        mdLink('Pausas ativas no trabalho', '/blog/pausas-ativas-no-trabalho'),
        mdLink('Como recuperar de um burnout: o papel do exercício', '/blog/como-recuperar-de-um-burnout'),
        mdLink('Bem-estar para colaboradores', '/blog/beneficios-bem-estar-colaboradores'),
        '',
        '## Contacto',
        `- Site: ${o}/`,
