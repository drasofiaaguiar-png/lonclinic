...
(function () {
    ...
    const INDEX = [
        ...
        { s: '#lon-service-psicologia-burnout h3', en: 'Burnout Psychology', pt: 'Psicologia em Burnout', es: 'Psicología en Burnout' },
        { s: '#lon-service-psicologia-burnout .lon-service-extra a', en: 'Take the burnout test →', pt: 'Fazer teste de burnout →', es: 'Hacer test de burnout →' },
