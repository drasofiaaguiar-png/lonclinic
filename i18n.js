...
(function () {
    ...
    const INDEX = [
        ...
        { s: '#lon-offer-nutricao h4', en: '6-month nutrition programme', pt: 'Programa de nutrição · 6 meses', es: 'Programa de nutrición · 6 meses' },
