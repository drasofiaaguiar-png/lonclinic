...
(function () {
    ...
    const INDEX = [
        ...
        { s: '.dr-lead', en: 'Medical consultations, mental health and nutrition with professionals who know your story and follow your health over the long term.', pt: 'Consultas médicas, saúde mental e nutrição com profissionais que conhecem a sua história e acompanham a sua saúde a longo prazo.', es: 'Consultas médicas, salud mental y nutrición con profesionales que conocen su historia y acompañan su salud a largo plazo.' },
        ...
        { s: '#lon-service-psicologia-burnout .lon-service-price', en: '56 € /month · all psychology programmes', pt: '56 € /mês · todos os programas de psicologia', es: '56 € /mes · todos los programas de psicología' },
        ...
        { s: '.lon-how-steps li:nth-child(1) p', en: 'Tell us what you need — we point you to the right consultation.', pt: 'Diga o que precisa — nós indicamos a consulta certa.', es: 'Diga qué necesita — le indicamos la consulta adecuada.' },
        ...
        /* ── Need chooser ── */
        { s: '.lon-need-kicker', en: 'How can we help?', pt: 'Em que podemos ajudar?', es: '¿En qué podemos ayudar?' },
        { s: '#lon-need-title', en: 'What do you need today?', pt: 'O que precisa hoje?', es: '¿Qué necesita hoy?' },
        { s: '.lon-need-lead', en: 'Choose what you need. We will help you find the right consultation.', pt: 'Escolha o que precisa. Nós ajudamos a encontrar a consulta certa.', es: 'Elija lo que necesita. Le ayudamos a encontrar la consulta adecuada.' },
        { s: '#lon-need-medico h3', en: 'I need to speak to a doctor', pt: 'Preciso de falar com um médico', es: 'Necesito hablar con un médico' },
        { s: '#lon-need-medico p', en: 'GP appointments, symptoms, check-up and follow-up.', pt: 'Consultas de clínica geral, sintomas, check-up e acompanhamento.', es: 'Consultas de medicina general, síntomas, chequeo y seguimiento.' },
        { s: '#lon-need-psico h3', en: 'I need psychological support', pt: 'Preciso de apoio psicológico', es: 'Necesito apoyo psicológico' },
        { s: '#lon-need-psico p', en: 'Mental health, anxiety, stress, burnout and follow-up.', pt: 'Saúde mental, ansiedade, stress, burnout e acompanhamento.', es: 'Salud mental, ansiedad, estrés, burnout y seguimiento.' },
        { s: '#lon-need-viagem h3', en: 'I am travelling', pt: 'Vou viajar', es: 'Voy a viajar' },
        { s: '#lon-need-viagem p', en: 'Travel clinic, prevention and advice before your trip.', pt: 'Consulta do viajante, prevenção e aconselhamento antes da viagem.', es: 'Consulta del viajero, prevención y consejo antes del viaje.' },
        ...
        { s: '#lon-need-nutricao p', en: 'Nutrition, prevention and personalised follow-up.', pt: 'Nutrição, prevenção e acompanhamento personalizado.', es: 'Nutrición, prevención y seguimiento personalizado.' },
        { s: '#lon-need-urgente h3', en: 'I need an urgent appointment', pt: 'Preciso de uma consulta urgente', es: 'Necesito una consulta urgente' },
        { s: '#lon-need-urgente p', en: 'For clinical situations that need a prompt medical assessment.', pt: 'Para situações clínicas que precisam de avaliação médica rápida.', es: 'Para situaciones clínicas que necesitan una evaluación médica rápida.' },
        { s: '#lon-need-medico .lon-need-cta, #lon-need-psico .lon-need-cta, #lon-need-viagem .lon-need-cta, #lon-need-nutricao .lon-need-cta', en: 'View consultations', pt: 'Ver consultas', es: 'Ver consultas' },
        { s: '#lon-need-urgente .lon-need-cta', en: 'Urgent consultation', pt: 'Consulta urgente', es: 'Consulta urgente' },
        ...
        { s: '#lon-service-psicologia-burnout .lon-btn-soft', en: 'Subscribe — 56 €/month', pt: 'Subscrever — 56 €/mês', es: 'Suscribirse — 56 €/mes' },
        ...
        { s: '.lon-team-more', en: 'View physician profile', pt: 'Ver perfil da médica', es: 'Ver perfil de la médica' },
        ...
        { s: '.lon-testimonial-tp .lon-testimonial-quote', en: 'I had a great experience with the video consultation. I was able to book an appointment for the same day and, at the end, I also received the prescription for the vaccines I needed. Dr. Rita was very friendly, attentive and professional, answered my questions and gave me several useful recommendations to prevent common health problems while travelling. I was very satisfied with the care and recommend it!', pt: '«Tive uma ótima experiência com a teleconsulta. Consegui marcar a consulta para o próprio dia e, no final, tive também a prescrição das vacinas de que precisava. A Dra. Rita foi muito simpática, atenciosa e profissional, esclareceu as minhas dúvidas e deu-me várias recomendações úteis para prevenir problemas de saúde comuns durante a viagem. Fiquei muito satisfeito com o atendimento e recomendo!»', es: 'Tuve una experiencia excelente con la teleconsulta. Pude reservar la cita para el mismo día y, al final, también recibí la receta de las vacunas que necesitaba. La Dra. Rita fue muy amable, atenta y profesional, resolvió mis dudas y me dio varias recomendaciones útiles para prevenir problemas de salud comunes durante el viaje. Quedé muy satisfecho con la atención y lo recomiendo.' },
        ...
        { s: '.lon-trustpilot-label', en: 'Review us on Trustpilot', pt: 'Avaliar no Trustpilot', es: 'Valóranos en Trustpilot' },
        ...
        { s: '.lon-footer-col:nth-child(3) a[href="/equipa/rita-aguiar"]', en: 'Our team', pt: 'A equipa', es: 'Nuestro equipo' },
    ...
    const BOOK = [
        ...
        { s: '#checkoutDetailsLead', en: 'We only need your email and phone number to confirm the booking and send you the appointment link.', pt: 'Só precisamos do seu email e telemóvel para confirmar a marcação e enviar o link da consulta.', es: 'Solo necesitamos su correo y su móvil para confirmar la reserva y enviarle el enlace de la consulta.' },
        ...
        { s: '#checkoutBeforeTitle', en: 'Next step', pt: 'Próximo passo', es: 'Siguiente paso' },
        { s: '#checkoutBeforeLead', en: 'Once the booking is complete you will receive a form by email to fill in your symptoms and clinical information securely. This lets the professional prepare for your appointment in advance.', pt: 'Depois de concluir o agendamento receberá no email um formulário para preencher os seus sintomas e informação clínica de forma segura. Assim, o profissional que o acompanha prepara a consulta com antecedência.', es: 'Tras completar la reserva recibirá por correo un formulario para completar sus síntomas e información clínica de forma segura. Así, el profesional que le atiende prepara la consulta con antelación.' },
    ...
    const BOOKING_STRINGS = {
        en: {
            ...
            durations: {
                ...
                psicologia_mensal: '50 minutes · billed monthly',
        ...
        pt: {
            ...
            durations: {
                ...
                psicologia_mensal: '50 minutos · cobrado mensalmente',
                terapia_casal: '50–60 min',
        ...
        es: {
            ...
            durations: {
                ...
                saude_mental: '30–45 min',
                psicologia: '50 minutos',
                psicologia_mensal: '50 minutos · cobrado mensualmente',
                terapia_casal: '50–60 min',
