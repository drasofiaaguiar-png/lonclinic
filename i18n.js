...
(function () {
    ...
    const BOOK = [
        ...
        { s: '[data-service="longevity"] h3', en: 'Longevity Assessment', pt: 'Avaliação de Longevidade' },
        { s: '[data-service="longevity"] .service-info > p', en: 'Comprehensive preventive health consultation focused on long-term wellbeing, risk detection, and personalized longevity planning.', pt: 'Consulta de saúde preventiva abrangente focada no bem-estar a longo prazo, deteção de riscos e planeamento de longevidade personalizado.' },
        { s: '[data-service="travel"] h3', en: 'Travel Medicine Consultation', pt: 'Consulta de Medicina de Viagem' },
        { s: '[data-service="travel"] .service-info > p', en: 'Destination-specific travel health planning including vaccinations, malaria prevention, travel prescriptions, and medical travel kit guidance.', pt: 'Planeamento de saúde de viagem específico por destino incluindo vacinações, prevenção de malária, prescrições de viagem e orientação para kit médico de viagem.' },
        { s: '[data-service="followup"] h3', en: 'Follow-Up Consultation', pt: 'Consulta de Seguimento' },
        { s: '[data-service="followup"] .service-info > p', en: 'Continuing care session to review progress, update your plan, discuss new results, or address follow-up questions with your physician.', pt: 'Sessão de continuação de cuidados para rever progressos, atualizar o seu plano, discutir novos resultados ou abordar questões de seguimento com o seu médico.' },
        { s: '#next-1', en: 'Continue to scheduling', pt: 'Continuar para agendamento' },

        /* ── Service details labels ── */
        { s: '[data-service="longevity"] .service-duration', en: ' 45–60 min', pt: ' 45–60 min', h: true },
        { s: '[data-service="travel"] .service-duration', en: ' 30–45 min', pt: ' 30–45 min', h: true },
        { s: '[data-service="followup"] .service-duration', en: ' 20–30 min', pt: ' 20–30 min', h: true },
