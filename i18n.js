...
(function () {
    ...
    const LON_NAV = [
        ...
        { s: '.lon-nav-links a[href="/consulta"]:not(.lon-mega-trigger), .lon-nav-links .lon-mega-trigger-label, .lon-mobile-menu a[href="/consulta"]', en: 'Specialties', pt: 'Especialidades', es: 'Especialidades' },
        { s: '.lon-nav-links a[href="/burnout"], .lon-mobile-menu a[href="/burnout"]', en: 'Burnout', pt: 'Burnout', es: 'Burnout' },
        { s: '.lon-nav-links > a[href="/travel-clinic"], .lon-mobile-menu > a[href="/travel-clinic"]', en: 'Travel', pt: 'Viajante', es: 'Viajero' },
        { s: '.lon-nav-links > a[href="/saudemental"], .lon-mobile-menu > a[href="/saudemental"]', en: 'Psychology', pt: 'Psicologia', es: 'Psicología' },
        { s: '.lon-nav-links > a[href="/nutricao"], .lon-mobile-menu > a[href="/nutricao"]', en: 'Nutrition', pt: 'Nutrição', es: 'Nutrición' },
        { s: '.lon-nav-links a[href="/magazine"], .lon-mobile-menu a[href="/magazine"]', en: 'Magazine', pt: 'Magazine', es: 'Magazine' },
        { s: '.lon-nav-links a[href="/#equipa"], .lon-mobile-menu a[href="/#equipa"], .lon-nav-links a[href="#equipa"], .lon-mobile-menu a[href="#equipa"], .lon-nav-links a[href="/equipa"], .lon-mobile-menu a[href="/equipa"]', en: 'Team', pt: 'Equipa', es: 'Equipo' },
    ...
    const INDEX = [
        ...
        { s: '#lon-need-psico h3', en: 'I feel sad or anxious', pt: 'Sinto-me triste ou ansioso', es: 'Me siento triste o ansioso' },
        ...
        { s: '#lon-need-nutricao .lon-need-desc', en: 'Nutritional follow-up to lose weight or build healthier habits — a 6-month programme or a single consultation.', pt: 'Acompanhamento nutricional para perder peso ou criar hábitos mais saudáveis — programa de 6 meses ou consulta avulsa.', es: 'Acompañamiento nutricional para perder peso o crear hábitos más saludables — programa de 6 meses o consulta suelta.' },
        ...
        { s: '#lon-offer-psico h4', en: 'Psychology Session · 50 min', pt: 'Sessão de Psicologia · 50 min', es: 'Sesión de Psicología · 50 min' },
        { s: '#lon-offer-psico .lon-need-offer-price', en: '60 € · no commitment', pt: '60 € · sem compromisso', es: '60 € · sin compromiso' },
        { s: '#lon-offer-psico .lon-need-offer-desc', en: 'Continue: 56 €/session weekly', pt: 'Continuar: 56 €/sessão semanal', es: 'Continuar: 56 €/sesión semanal' },
        { s: '#lon-offer-psico .lon-btn', en: 'Book — 60 €', pt: 'Marcar — 60 €', es: 'Reservar — 60 €' },
        ...
        { s: '#lon-offer-saude-mental .lon-need-offer-price', en: '60 € · 30 min', pt: '60 € · 30 min', es: '60 € · 30 min' },
        ...
        { s: '#lon-offer-nutricao h4', en: 'Nutritional follow-up programme · 6 months', pt: 'Programa de acompanhamento nutricional · 6 meses', es: 'Programa de acompañamiento nutricional · 6 meses' },
        ...
        { s: '#lon-offer-nutricao .lon-need-offer-price', en: '490 € total · 115 € in month 1, then 75 €/month', pt: '490 € no total · 115 € no mês 1, depois 75 €/mês', es: '490 € en total · 115 € en el mes 1, después 75 €/mes' },
        { s: '#lon-offer-nutricao .lon-btn', en: 'Book — 115 €', pt: 'Marcar — 115 €', es: 'Reservar — 115 €' },
        { s: '#lon-offer-nutricao-consulta h4', en: 'Nutrition Consultation', pt: 'Consulta de Nutrição', es: 'Consulta de Nutrición' },
        { s: '#lon-offer-nutricao-consulta .lon-need-offer-price', en: '45 € · 30 min', pt: '45 € · 30 min', es: '45 € · 30 min' },
        { s: '#lon-offer-nutricao-consulta .lon-btn', en: 'Book — 45 €', pt: 'Marcar — 45 €', es: 'Reservar — 45 €' },
        { s: '#lon-offer-nutricao-acompanhamento h4', en: 'Nutritional follow-up', pt: 'Acompanhamento nutricional', es: 'Acompañamiento nutricional' },
        { s: '#lon-offer-nutricao-acompanhamento .lon-need-offer-price', en: '€45 every 15 days', pt: '45 € a cada 15 dias', es: '45 € cada 15 días' },
        { s: '#lon-offer-nutricao-acompanhamento .lon-need-offer-desc', en: 'Billed every 15 days — first payment is €45', pt: 'Paga de 15 em 15 dias — o primeiro valor é 45 €', es: 'Paga cada 15 días — el primer importe es 45 €' },
        { s: '#lon-offer-nutricao-acompanhamento .lon-btn', en: 'Book — 45 €', pt: 'Marcar — 45 €', es: 'Reservar — 45 €' },
        { s: '#lon-service-nutricao-acompanhamento h3', en: 'Nutritional follow-up', pt: 'Acompanhamento nutricional', es: 'Acompañamiento nutricional' },
        { s: '#lon-service-nutricao-acompanhamento .lon-service-price', en: '€45 every 15 days', pt: '45 € a cada 15 dias', es: '45 € cada 15 días' },
        ...
        /* ── Service chips ── */
        { s: '#lon-service-clinica-geral .lon-service-chip', en: 'General Medicine', pt: 'Medicina Geral', es: 'Medicina General' },
        { s: '#lon-service-urgente .lon-service-chip', en: 'Urgent', pt: 'Urgência', es: 'Urgencia' },
        ...
        /* ── Service names ── */
        { s: '#lon-service-clinica-geral h3', en: 'General Medicine Consultation', pt: 'Consulta de Clínica Geral', es: 'Consulta de Medicina General' },
        { s: '#lon-service-urgente h3', en: 'Urgent Medical Consultation', pt: 'Consulta Médica Urgente', es: 'Consulta Médica Urgente' },
        ...
        { s: '#lon-service-nutricao-bimensal .lon-service-price', en: '45 € every 15 days', pt: '45 € a cada 15 dias', es: '45 € cada 15 días' },
        ...
        { s: '#lon-service-psicologia .lon-btn-soft', en: 'Book — 60 €', pt: 'Marcar — 60 €', es: 'Reservar — 60 €' },
        { s: '#lon-service-psicologia .lon-service-extra a', en: 'Continue weekly: 56 €/session →', pt: 'Continuar em semanal: 56 €/sessão →', es: 'Continuar semanal: 56 €/sesión →' },
        ...
        { s: '#lon-team-rita .lon-team-role', en: 'Specialist in Family Medicine', pt: 'Médica especialista em Medicina Geral e Familiar', es: 'Médica especialista en Medicina Familiar y Comunitaria' },
        { s: '#lon-team-rita .lon-team-bio', en: 'Lead physician at Lon Clinic, registered with the Portuguese Medical Association. 9 years of clinical practice, including telemedicine and team follow-up.', pt: 'Médica responsável da Lon Clinic, inscrita na Ordem dos Médicos. 9 anos de prática clínica, com telemedicina e acompanhamento da equipa.', es: 'Médica responsable de Lon Clinic, inscrita en el Colegio de Médicos. 9 años de práctica clínica, con telemedicina y seguimiento del equipo.' },
        ...
        { s: '#lon-team-sara .lon-team-bio', en: 'Psychologist at Lon Clinic. She supports adults through life transitions, anxiety and emotional stress, and works with self-esteem difficulties and personal growth.', pt: 'Psicóloga na Lon Clinic. Acompanha adultos em fases de transição, ansiedade e stress emocional, e trabalha dificuldades de autoestima e processos de crescimento pessoal.', es: 'Psicóloga en Lon Clinic. Acompaña a adultos en transiciones, ansiedad y estrés emocional, y trabaja dificultades de autoestima y procesos de crecimiento personal.' },
        ...
        { s: '#lon-team-sara-barreto .lon-team-bio', en: 'Nutritionist at Lon Clinic, registered with the Portuguese Order of Nutritionists (licence no. 6501N). She supports dietary re-education and weight loss without yo-yo dieting, with real food and habits that fit daily life.', pt: 'Nutricionista na Lon Clinic, inscrita na Ordem dos Nutricionistas (cédula n.º 6501N). Acompanha reeducação alimentar e perda de peso sem ioiô, com comida real e hábitos que cabem no dia a dia.', es: 'Nutricionista en Lon Clinic, inscrita en el Colegio de Nutricionistas (cédula n.º 6501N). Acompaña la reeducación alimentaria y la pérdida de peso sin efecto yo-yo, con comida real y hábitos que encajan en el día a día.' },
        ...
        { s: '.lon-footer-col:nth-child(3) a[href="/info/sobre-nos"]', en: 'About us', pt: 'Sobre nós', es: 'Sobre nosotros' },
        { s: '.lon-footer-col:nth-child(3) a[href="/equipa"], .lon-footer-col:nth-child(3) a[href="/equipa/rita-aguiar"]', en: 'Team', pt: 'Equipa', es: 'Equipo' },
        { s: '.lon-footer-col:nth-child(3) a[href="/info/parcerias"]', en: 'Partnerships', pt: 'Parcerias', es: 'Asociaciones' },
        { s: '.lon-footer-col:nth-child(3) a[href="/info/registo-medico"]', en: 'Medical records', pt: 'Registo Médico', es: 'Registro médico' },
        { s: '.lon-footer-col:nth-child(3) a[href="/info/contato"]', en: 'Contact', pt: 'Contacto', es: 'Contacto' },
        { s: '.lon-footer-col:nth-child(3) a[href="/info/trabalhe-connosco"]', en: 'Work with us', pt: 'Trabalhe Connosco', es: 'Trabaje con nosotros' },
        { s: 'a.lon-footer-pro[href="/profissional"]', en: 'Professional area', pt: 'Área do profissional', es: 'Área del profesional' },
        { s: '.lon-footer-col:nth-child(4) a[href="/info/como-funciona"]', en: 'How it works', pt: 'Como funciona', es: 'Cómo funciona' },
        { s: '.lon-footer-col:nth-child(4) a[href="/faq"]', en: 'Frequently asked questions', pt: 'Perguntas Frequentes', es: 'Preguntas frecuentes' },
        { s: '.lon-footer-col:nth-child(4) a[href="/info/seguranca-dados"]', en: 'Data security', pt: 'Segurança dos Dados', es: 'Seguridad de datos' },
        { s: '.lon-footer-col:nth-child(4) a[href="/info/acessibilidade"]', en: 'Accessibility', pt: 'Acessibilidade', es: 'Accesibilidad' },
        { s: '.lon-footer-col:nth-child(4) a[href="/info/reclamacoes"]', en: 'Complaints', pt: 'Reclamações', es: 'Reclamaciones' },
        { s: '.lon-footer-col:nth-child(4) a[href="/magazine"]', en: 'Magazine', pt: 'Magazine', es: 'Magazine' },
        { s: '.lon-footer-legal-links a[href="/info/termos-condicoes"]', en: 'Terms and conditions', pt: 'Termos e Condições', es: 'Términos y condiciones' },
        { s: '.lon-footer-legal-links a[href="/info/politica-privacidade"]', en: 'Privacy policy', pt: 'Política de Privacidade', es: 'Política de privacidad' },
        { s: '.lon-footer-legal-links a[href="/info/cookies"]', en: 'Cookie policy', pt: 'Política de Cookies', es: 'Política de cookies' },
        { s: '.lon-footer-legal-links a[href="/info/acessibilidade"]', en: 'Accessibility', pt: 'Acessibilidade', es: 'Accesibilidad' },
    ...
    const BOOK = [
        ...
        { s: '#consentText', en: 'I accept the <a href="/info/termos-condicoes" style="color: var(--accent);">Terms and Conditions</a> and the <a href="/info/politica-privacidade" style="color: var(--accent);">Privacy Policy</a>, and I consent to the secure processing of my health data for this private medical consultation.', pt: 'Aceito os <a href="/info/termos-condicoes" style="color: var(--accent);">Termos e Condições</a> e a <a href="/info/politica-privacidade" style="color: var(--accent);">Política de Privacidade</a>, e autorizo o tratamento seguro dos meus dados de saúde para esta consulta médica privada.', es: 'Acepto los <a href="/info/termos-condicoes" style="color: var(--accent);">Términos y Condiciones</a> y la <a href="/info/politica-privacidade" style="color: var(--accent);">Política de privacidad</a>, y autorizo el tratamiento seguro de mis datos de salud para esta consulta médica privada.', h: true },
    ...
    const MARCAR = [
        ...
        { s: '.lon-nav-links > a[href="/nutricao"], .lon-mobile-menu > a[href="/nutricao"]', en: 'Nutrition', pt: 'Nutrição', es: 'Nutrición' },
        { s: '.lon-nav-links a[href="/magazine"], .lon-mobile-menu a[href="/magazine"]', en: 'Magazine', pt: 'Magazine', es: 'Magazine' },
        { s: '.lon-nav-links a[href="/#equipa"], .lon-mobile-menu a[href="/#equipa"], .lon-nav-links a[href="/equipa"], .lon-mobile-menu a[href="/equipa"]', en: 'Team', pt: 'Equipa', es: 'Equipo' },
        { s: '.lon-nav-actions .lon-btn-ghost[href="/patient-portal"]', en: 'Login', pt: 'Login', es: 'Acceder' },
        { s: '.lon-nav-actions .lon-btn-primary[href="/marcar/clinica-geral"]:not([data-talk-cta])', en: 'Book — 39 €', pt: 'Marcar — 39 €', es: 'Reservar — 39 €' },
        ...
        { s: '#marcarNeedNutricao .marcar-need-desc', en: 'Fortnightly subscription · €45 / 15 days', pt: 'Subscrição quinzenal · 45 € / 15 dias', es: 'Suscripción quincenal · 45 € / 15 días' },
    ...
    const BOOKING_STRINGS = {
        en: {
            ...
            services: {
                ...
                nutricao_quinzenal: 'Nutrition subscription · fortnightly',
            ...
            durations: {
                ...
                nutricao_quinzenal: '€45 every 15 days',
        ...
        pt: {
            ...
            services: {
                ...
                nutricao_quinzenal: 'Subscrição de nutrição · quinzenal',
            ...
            durations: {
                ...
                nutricao_quinzenal: '45 € a cada 15 dias',
        ...
        es: {
            ...
            services: {
                ...
                nutricao_quinzenal: 'Suscripción de nutrición · quincenal',
            ...
            durations: {
                ...
                longevidade: '45–60 min',
                nutricao_consulta: '30 minutos',
                nutricao_quinzenal: '45 € cada 15 días',
