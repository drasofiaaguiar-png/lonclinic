...
(function () {
    ...
    const INDEX = [
        ...
        /* ── Intro ── */
        { s: '.lon-intro .lon-kicker', en: 'A clinic, not just a platform', pt: 'Uma clínica, não apenas uma plataforma', es: 'Una clínica, no solo una plataforma' },
        { s: '#lon-intro-title', en: 'Health is more than solving a problem when it appears.', pt: 'Saúde é mais do que resolver um problema quando ele aparece.', es: 'La salud es más que resolver un problema cuando aparece.' },
        { s: '.lon-intro-body p:nth-child(1)', en: 'At Lon Clinic, we believe good healthcare starts by listening.', pt: 'Na Lon Clinic, acreditamos que bons cuidados de saúde começam por ouvir.', es: 'En Lon Clinic, creemos que unos buenos cuidados de salud empiezan por escuchar.' },
        ...
        { s: '.dr-burnout-promo__meta', en: '4 minutes · Free · Immediate result', pt: '4 minutos · Gratuito · Resultado imediato', es: '4 minutos · Gratuito · Resultado inmediato' },
        ...
        { s: '#lon-need-medico p', en: 'Symptoms, health questions, recurring problems, medication, tests or follow-up.', pt: 'Sintomas, dúvidas de saúde, problemas recorrentes, medicação, exames ou acompanhamento.', es: 'Síntomas, dudas de salud, problemas recurrentes, medicación, pruebas o seguimiento.' },
        { s: '#lon-need-psico h3', en: 'I am not feeling well', pt: 'Não me estou a sentir bem', es: 'No me estoy sintiendo bien' },
        { s: '#lon-need-psico p', en: 'Anxiety, stress, burnout, emotional difficulties, relationships, or simply the need to talk to someone.', pt: 'Ansiedade, stress, burnout, dificuldades emocionais, relações ou simplesmente a necessidade de falar com alguém.', es: 'Ansiedad, estrés, burnout, dificultades emocionales, relaciones o simplemente la necesidad de hablar con alguien.' },
        { s: '#lon-need-viagem h3', en: 'I am travelling', pt: 'Vou viajar', es: 'Voy a viajar' },
        { s: '#lon-need-viagem p', en: 'Prepare your health before you travel with personalised advice on prevention, vaccination and destination-related risks.', pt: 'Prepare a sua saúde antes de viajar com aconselhamento personalizado sobre prevenção, vacinação e riscos associados ao destino.', es: 'Prepare su salud antes de viajar con consejo personalizado sobre prevención, vacunación y riesgos asociados al destino.' },
        { s: '#lon-need-nutricao h3', en: 'I want to take better care of my health', pt: 'Quero cuidar melhor da minha saúde', es: 'Quiero cuidar mejor mi salud' },
        { s: '#lon-need-nutricao p', en: 'Nutrition, prevention and personalised follow-up to build healthier, more sustainable habits.', pt: 'Nutrição, prevenção e acompanhamento personalizado para criar hábitos mais saudáveis e sustentáveis.', es: 'Nutrición, prevención y seguimiento personalizado para crear hábitos más saludables y sostenibles.' },
        ...
        { s: '#lon-need-urgente p', en: 'For clinical situations that need a prompt medical assessment, but are not emergencies.', pt: 'Para situações clínicas que necessitam de avaliação médica rápida, mas que não são emergências.', es: 'Para situaciones clínicas que necesitan una evaluación médica rápida, pero que no son emergencias.' },
        { s: '#lon-need-medico .lon-need-cta', en: 'See medical consultations →', pt: 'Ver consultas médicas →', es: 'Ver consultas médicas →' },
        { s: '#lon-need-psico .lon-need-cta', en: 'See Mental Health →', pt: 'Ver Saúde Mental →', es: 'Ver Salud Mental →' },
        { s: '#lon-need-viagem .lon-need-cta', en: 'Prepare my trip →', pt: 'Preparar a minha viagem →', es: 'Preparar mi viaje →' },
        { s: '#lon-need-nutricao .lon-need-cta', en: 'See Nutrition →', pt: 'Ver Nutrição →', es: 'Ver Nutrición →' },
        { s: '#lon-need-urgente .lon-need-cta', en: 'Book urgent consultation →', pt: 'Marcar consulta urgente →', es: 'Reservar consulta urgente →' },
        ...
        /* ── Care overview ── */
        { s: '.lon-care-header .lon-need-kicker', en: 'Online healthcare', pt: 'Cuidados de saúde online', es: 'Cuidados de salud online' },
        { s: '#lon-care-title', en: 'A clinic for different needs.', pt: 'Uma clínica para diferentes necessidades.', es: 'Una clínica para distintas necesidades.' },
        { s: '.lon-care-header .lon-need-lead', en: 'Find the right professional for the moment you are in.', pt: 'Encontre o profissional certo para o momento em que está.', es: 'Encuentre al profesional adecuado para el momento en que se encuentra.' },
        { s: '.lon-care-card:nth-child(1) h3', en: 'General Medicine', pt: 'Medicina Geral', es: 'Medicina General' },
        { s: '.lon-care-card:nth-child(1) p:nth-of-type(1)', en: 'Medical consultations for symptoms, health questions, recurring problems, follow-up and prevention.', pt: 'Consultas médicas para sintomas, dúvidas de saúde, problemas recorrentes, acompanhamento e prevenção.', es: 'Consultas médicas para síntomas, dudas de salud, problemas recurrentes, seguimiento y prevención.' },
        { s: '.lon-care-card:nth-child(1) .lon-care-offer', en: 'General Medicine consultation · <strong>39 € · 30 min</strong>', pt: 'Consulta de Clínica Geral · <strong>39 € · 30 min</strong>', es: 'Consulta de Medicina General · <strong>39 € · 30 min</strong>', h: true },
        { s: '.lon-care-card:nth-child(1) .lon-care-note', en: 'For clinical situations that do not require a specialty consultation or immediate in-person assessment.', pt: 'Para situações clínicas que não requerem uma consulta de especialidade ou avaliação presencial imediata.', es: 'Para situaciones clínicas que no requieren una consulta de especialidad ni una evaluación presencial inmediata.' },
        { s: '.lon-care-card:nth-child(1) .lon-btn', en: 'Book consultation — 39 €', pt: 'Marcar consulta — 39 €', es: 'Reservar consulta — 39 €' },
        { s: '.lon-care-card:nth-child(2) h3', en: 'Urgent Medical Consultation', pt: 'Consulta Médica Urgente', es: 'Consulta Médica Urgente' },
        { s: '.lon-care-card:nth-child(2) p:nth-of-type(1)', en: 'When you need a prompt medical assessment.', pt: 'Quando precisa de uma avaliação médica rápida.', es: 'Cuando necesita una evaluación médica rápida.' },
        { s: '.lon-care-card:nth-child(2) .lon-care-offer', en: '<strong>35 € · 20–30 min</strong>', pt: '<strong>35 € · 20–30 min</strong>', es: '<strong>35 € · 20–30 min</strong>', h: true },
        { s: '.lon-care-card:nth-child(2) .lon-btn', en: 'Book consultation — 35 €', pt: 'Marcar consulta — 35 €', es: 'Reservar consulta — 35 €' },
        { s: '.lon-care-card:nth-child(3) h3', en: 'Mental Health', pt: 'Saúde Mental', es: 'Salud Mental' },
        { s: '.lon-care-card:nth-child(3) p', en: 'Psychological support for anxiety, stress, burnout, emotional difficulties and other mental health questions.', pt: 'Acompanhamento psicológico para ansiedade, stress, burnout, dificuldades emocionais e outras questões de saúde mental.', es: 'Acompañamiento psicológico para ansiedad, estrés, burnout, dificultades emocionales y otras cuestiones de salud mental.' },
        { s: '.lon-care-card:nth-child(3) .lon-text-link', en: 'See Mental Health consultations →', pt: 'Ver consultas de Saúde Mental →', es: 'Ver consultas de Salud Mental →' },
        { s: '.lon-care-card:nth-child(4) h3', en: "Traveller's Health", pt: 'Saúde do Viajante', es: 'Salud del Viajero' },
        { s: '.lon-care-card:nth-child(4) p', en: 'Medical advice before travel, prevention, vaccination and preparation according to your destination.', pt: 'Aconselhamento médico antes da viagem, prevenção, vacinação e preparação de acordo com o destino.', es: 'Asesoramiento médico antes del viaje, prevención, vacunación y preparación según el destino.' },
        { s: '.lon-care-card:nth-child(4) .lon-text-link', en: "Book traveller's consultation →", pt: 'Marcar consulta do viajante →', es: 'Reservar consulta del viajero →' },
        { s: '.lon-care-card:nth-child(5) h3', en: 'Nutrition', pt: 'Nutrição', es: 'Nutrición' },
        { s: '.lon-care-card:nth-child(5) p', en: 'Personalised nutritional follow-up to improve habits, health and wellbeing.', pt: 'Acompanhamento nutricional personalizado para melhorar hábitos, saúde e bem-estar.', es: 'Seguimiento nutricional personalizado para mejorar hábitos, salud y bienestar.' },
        { s: '.lon-care-card:nth-child(5) .lon-text-link', en: 'See Nutrition consultations →', pt: 'Ver consultas de Nutrição →', es: 'Ver consultas de Nutrición →' },
        { s: '.lon-care-card:nth-child(6) h3', en: 'Longevity Medicine', pt: 'Medicina da Longevidade', es: 'Medicina de la Longevidad' },
        { s: '.lon-care-card:nth-child(6) p', en: 'Preventive follow-up for those who want to take care of their health today and invest in their future health.', pt: 'Acompanhamento preventivo para quem quer cuidar da saúde hoje e investir na saúde do futuro.', es: 'Seguimiento preventivo para quien quiere cuidar la salud hoy e invertir en la salud del futuro.' },
        { s: '.lon-care-card:nth-child(6) .lon-text-link', en: 'Explore Longevity →', pt: 'Conhecer Longevidade →', es: 'Conocer Longevidad →' },
        ...
        /* ── Trust / ERS ── */
        { s: '.lon-ers-home .lon-kicker', en: 'A registered and regulated clinic', pt: 'Uma clínica registada e regulada', es: 'Una clínica registrada y regulada' },
        { s: '#lon-ers-title', en: 'Healthcare with responsibility.', pt: 'Cuidados de saúde com responsabilidade.', es: 'Cuidados de salud con responsabilidad.' },
        { s: '.lon-ers-home .lon-section-lead', en: 'Lon Clinic is a health clinic registered with the Health Regulatory Authority.', pt: 'A Lon Clinic é uma clínica de saúde registada na Entidade Reguladora da Saúde.', es: 'Lon Clinic es una clínica de salud registrada en la Entidad Reguladora de la Salud.' },
        { s: '.lon-ers-number-label', en: 'ERS registration no.', pt: 'N.º de Registo ERS', es: 'N.º de registro ERS' },
        { s: '.lon-ers-points h3:nth-of-type(1)', en: 'Qualified professionals', pt: 'Profissionais qualificados', es: 'Profesionales cualificados' },
        { s: '.lon-ers-points p:nth-of-type(1)', en: 'Our doctors are registered with the Medical Association. Psychologists and nutritionists are registered with their respective professional bodies.', pt: 'Os nossos médicos são inscritos na Ordem dos Médicos. Psicólogos e nutricionistas são inscritos nas respetivas Ordens profissionais.', es: 'Nuestros médicos están inscritos en el Colegio de Médicos. Psicólogos y nutricionistas están inscritos en sus respectivos Colegios profesionales.' },
        { s: '.lon-ers-points h3:nth-of-type(2)', en: 'Consultations in three languages', pt: 'Consultas em três idiomas', es: 'Consultas en tres idiomas' },
        { s: '.lon-ers-points p:nth-of-type(2)', en: 'Portuguese · English · Spanish', pt: 'Português · Inglês · Espanhol', es: 'Portugués · Inglés · Español' },
        { s: '.lon-ers-points h3:nth-of-type(3)', en: 'Privacy', pt: 'Privacidade', es: 'Privacidad' },
        { s: '.lon-ers-points p:nth-of-type(3)', en: 'We process your health data in accordance with the requirements applicable to the provision of healthcare.', pt: 'Tratamos os seus dados de saúde de acordo com os requisitos aplicáveis à prestação de cuidados de saúde.', es: 'Tratamos sus datos de salud de acuerdo con los requisitos aplicables a la prestación de cuidados de salud.' },
        { s: '.lon-ers-links a[href="/info.html?page=seguranca-dados"]', en: 'Read our security policies →', pt: 'Conhecer as nossas políticas de segurança →', es: 'Conocer nuestras políticas de seguridad →' },
        { s: '.lon-ers-links a[href="https://www.ers.pt/"]', en: 'Check the clinic registration →', pt: 'Consultar registo da clínica →', es: 'Consultar el registro de la clínica →' },
