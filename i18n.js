...
(function () {
    ...
    const INDEX = [
        ...
        { s: '#lon-offer-psico-sub h4', en: 'Psychology Consultation 1×/week · 45 min/session', pt: 'Consulta de Psicologia 1x/semana · 45 min/sessão', es: 'Consulta de Psicología 1×/semana · 45 min/sesión' },
        { s: '#lon-offer-psico-sub .lon-need-offer-price', en: '1 session per week · 56 €/week · billed monthly', pt: '1 sessão por semana · 56 €/semana · cobrado mensalmente', es: '1 sesión por semana · 56 €/semana · cobrado mensualmente' },
        ...
        { s: '#lon-service-nutricao-bimensal .lon-service-price', en: '90 €/month', pt: '90 €/mês', es: '90 €/mes' },
        ...
        { s: '#lon-service-psicologia-sub .lon-service-chip', en: 'Subscription', pt: 'Subscrição', es: 'Suscripción' },
        { s: '#lon-service-psicologia-sub h3', en: 'Psychology subscription', pt: 'Subscrição de Psicologia', es: 'Suscripción de psicología' },
        { s: '#lon-service-psicologia-sub .lon-service-price', en: '56 € /week · billed monthly', pt: '56 € /semana · cobrado mensalmente', es: '56 € /semana · cobrado mensualmente' },
        { s: '#lon-service-psicologia-sub .lon-btn-soft', en: 'Subscribe — 56 €/week', pt: 'Subscrever — 56 €/semana', es: 'Suscribirse — 56 €/semana' },
        { s: '#lon-service-psicologia-sub .lon-service-extra a', en: 'See psychology programmes →', pt: 'Ver programas de psicologia →', es: 'Ver programas de psicología →' },
    ...
    const BOOKING_STRINGS = {
        en: {
            ...
            durations: {
                ...
                nutricao_quinzenal: '30–45 min · 2 per month',
        ...
        pt: {
            ...
            durations: {
                ...
                nutricao_quinzenal: '30–45 min · 2 por mês · cobrado mensalmente',
        ...
        es: {
            ...
            durations: {
                ...
                longevidade: '45–60 min',
                nutricao_consulta: '30 minutos',
                nutricao_quinzenal: '30–45 min · 2 al mes · cobrado mensualmente',
